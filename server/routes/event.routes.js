...
module.exports = function (apiRouter) {
    ...
    // Path: /event/all
    // ==================================================
    userRouter.route("/all").post(optionalLogin, canGetAll, getAll);

    // Workshop
    // Path: /event/:eventId
    // ==================================================
    userRouter.route("/:eventId/container").get(optionalLogin, optionalAdminView, getContainer);

    // Event start
    // Path: /event/:eventId/rating
    // ==================================================
    userRouter.route("/:eventId/rating").get(getRating);
  ...
  */
    ...
    // Path: /event
    // ==================================================
    userRouter.route("/start").post(canStart, start); // admin or owner

    // Event Registration
    // Get all the registrations done by a user
    // Path: /allRegistration
    // ==================================================
    userRouter.route("/all-registration").get(getAllRegistration); // everyone can get their own

    // Event upcoming
    // Path: /get-all-upcoming/
    userRouter.route("/get-all-upcoming").post(getAllUpcoming);

    // Event complete
    // Path: /event
    // ==================================================
    userRouter.route("/:eventId/complete").post(eventRequireActive, isAdminOrOwner, complete); // admin or owner
    ...
    // ==================================================
    userRouter.route("/:eventId/privacy").patch(eventRequireActive, isAdminOrOwner, updatePrivacy); // admin or owner

    // Update event's visibility
    // Path: /event/:eventId/visibility
    // ==================================================
    userRouter.route("/:eventId/visibility").patch(eventRequireActive, isAdminOrOwner, updateVisibility); // admin or owner

    userRouter
        .route("/:eventId/cover-photo")
        .patch(eventRequireActive, isAdminOrOwner, uploadAvatar("coverPhoto"), updateCoverPhoto); // admin or owner

    // Event
    // Path: /event/:eventId/eager
    // ==================================================
    userRouter.route("/:eventId/eager").get(eventRequireActive, isAdminOrOwner, getEager); // admin or owner
    ...
    // ==================================================
    userRouter
        .route("/:eventId/occurrence/:occurrenceId")
    ...
    // ==================================================
    userRouter
        .route("/:eventId/occurrence/:occurrenceId/registration")
    ...
    // ==================================================
    userRouter.route("/:eventId/registration").get(eventRequireActive, canGetRegistration, getRegistration); // everyone can get their own. admins/owners only if adminView is on for that event.

    // Event Registration
    // Path: /:eventId/registration/:registrationId
    // ==================================================
    userRouter
        .route("/:eventId/registration/:registrationId")
